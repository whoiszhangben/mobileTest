...
namespace SmoONE.UI
{
    ...
    public class AutofacConfig
    {
        ...
        /// 档案服务的相关接口
        /// </summary>
        public Application.IProfileService profileService;
        ...
        public void Init()
        {
            ...
            containerBuilder.RegisterType<ProfileRepository>().As<IProfileRepository>().InstancePerDependency();
            containerBuilder.RegisterType<ProfileTypeRepository>().As<IProfileTypeRepository>().InstancePerDependency();
        ...
        public AutofacConfig()
        {
            ...
            this.profileService = container.Resolve<IProfileService>();
        }
    }
}
